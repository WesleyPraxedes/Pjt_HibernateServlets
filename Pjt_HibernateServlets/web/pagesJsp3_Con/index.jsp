...
<html>
    <head>
        ...
        <title>CRUD Hibernate + JSP + Servlet "controladora".</title>
    </head>
    <body>
        <a href="../index.jsp">Home</a>
        <br/>
        <h1>CRUD Hibernate + JSP + Servlet "controladora"</h1>
            ...
            <tr>
                ...
                <td><%
                       try{
                        ...
                        %></td>
                <td><% out.print("<a href=servletController?encaminhar=ActionCliente&metodo=preencherForm&id_cliente="+cliente.getIdCliente()+" style='text-decoration:none'><input type='submit' value='Atualizar'/></a>"); %></td>
                <td><% out.print("<form method='post' action='servletController'><input type='hidden' name='encaminhar' value='ActionCliente'/><input type='hidden' name='metodo' value='excluir'/><input type='hidden' name='id_cliente' value='"+cliente.getIdCliente()+"' /><input type='submit' value='Excluir'/></form>"); %></td>
