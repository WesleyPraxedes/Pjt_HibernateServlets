...
<html>
    <head>
        ...
        <title>CRUD Hibernate + JSP + Servlet "individual".</title>
    </head>
    <body>
        <a href="../index.jsp">Home</a>
        <br/>
        <h1>CRUD Hibernate + JSP + Servlet "individual"</h1>
            ...
            <tr>
                ...
                <td><%
                       try{
                        ...
                        %></td>
                <td><% out.print("<a href=preencherForm?id_cliente="+cliente.getIdCliente()+">Atualizar</a>"); %></td>
                <td><% out.print("<a href=excluir?id_cliente="+cliente.getIdCliente()+">Excluir</a>"); %></td>
